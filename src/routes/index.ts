...
import academyPayoutRoutes from './academy/payout.routes';
import academyDashboardRoutes from './academy/dashboard.routes';
import academyCoachingCenterRatingRoutes from './academy/coachingCenterRating.routes';
...
router.use('/academy/my-payouts', academyPayoutRoutes);
router.use('/academy/dashboard', academyDashboardRoutes);
router.use('/academy/ratings', academyCoachingCenterRatingRoutes);
