...
exports.config = {
    ...
    database: {
        mongoUri: process.env.MONGO_URI || 'mongodb://localhost:27017/coaching_center_panel',
    },
    twilio: {
    ...
    demoAuth: {
        enabled: parseBoolean(process.env.DEMO_AUTH_ENABLED, process.env.NODE_ENV !== 'production'),
