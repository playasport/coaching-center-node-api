...
const options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'API documentation for PlayAsport Academy backend built with Node.js, TypeScript, Express, and MongoDB.',
            contact: {
                name: 'API Support',
            },
        },
                ...
                AcademyOtpRequest: {
                    ...
                    properties: {
                        ...
                        mode: {
                            ...
                            enum: ['login', 'register', 'profile_update', 'forgot_password'],
                            example: 'register',
                            description: 'Purpose of OTP. Defaults to login when omitted. Use profile_update for mobile change verification, forgot_password for password reset.',
                        },
                    },
                },
                        ...
                        },
                        {
                            ...
                            properties: {
                                ...
                                recommendedAcademies: {
                                    type: 'array',
                                    description: 'Up to 6 academies near this selected academy (distance is km from this center): same sports first; if logged in, fills remaining slots with favorite sports nearby',
                                    items: {
                                        $ref: '#/components/schemas/AcademyListItem',
                                    },
                                },
                                moreAcademyBranches: {
                                    type: 'array',
                                    description: 'Up to 6 other academies registered under the same academy owner user (excludes this academy)',
                                    items: {
                                        $ref: '#/components/schemas/AcademyListItem',
                                    },
                                },
