...
exports.getLimitedPublicSettings = void 0;
 ...
 */
const getLimitedPublicSettings = async (_req, res, next) => {
    try {
        const settings = await settingsService.getLimitedPublicSettings();
        const response = new ApiResponse_1.ApiResponse(200, { ...settings }, (0, i18n_1.t)('settings.get.success'));
        res.json(response);
    }
    catch (error) {
        next(error);
