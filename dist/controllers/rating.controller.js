...
exports.getUserRatings = void 0;
const ApiResponse_1 = require("../utils/ApiResponse");
const ApiError_1 = require("../utils/ApiError");
const i18n_1 = require("../utils/i18n");
const ratingService = __importStar(require("../services/client/coachingCenterRating.service"));
const getUserRatings = async (req, res, next) => {
    try {
        ...
        const response = new ApiResponse_1.ApiResponse(200, result, 'User ratings retrieved successfully');
        res.json(response);
    }
    catch (error) {
        next(error);
