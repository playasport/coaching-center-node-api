...
const getNotifications = async (req, res, next) => {
    try {
        ...
        const result = await notificationService.getNotifications('user', req.user.id, page, limit, isRead);
        const response = new ApiResponse_1.ApiResponse(200, result, (0, i18n_1.t)('notification.list.success'));
        res.json(response);
    }
    catch (error) {
        next(error);
...
const markAsRead = async (req, res, next) => {
    try {
        ...
        const response = new ApiResponse_1.ApiResponse(200, notification, (0, i18n_1.t)('notification.markRead.success'));
        res.json(response);
    }
    catch (error) {
        next(error);
...
const markAsUnread = async (req, res, next) => {
    try {
        ...
        const response = new ApiResponse_1.ApiResponse(200, notification, (0, i18n_1.t)('notification.markUnread.success'));
        res.json(response);
    }
    catch (error) {
        next(error);
