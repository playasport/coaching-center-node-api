...
const facilityService = __importStar(require("../services/common/facility.service"));
const getAllFacilities = async (req, res, next) => {
    try {
        const search = req.query.search;
        const facilities = await facilityService.getAllFacilities(search);
        const response = new ApiResponse_1.ApiResponse(200, { facilities }, (0, i18n_1.t)('facility.getAll.success'));
        res.json(response);
    }
    catch (error) {
        next(error);
