...
const dashboardService = __importStar(require("../services/client/dashboard.service"));
const getUserDashboard = async (req, res, next) => {
    try {
        ...
        const response = new ApiResponse_1.ApiResponse(200, dashboard, 'Dashboard retrieved successfully');
        res.json(response);
    }
    catch (error) {
        next(error);
