...
exports.generateBookingInvoice = void 0;
...
const loadLogoAsBase64 = async () => {
    try {
        ...
        logger_1.logger.warn('Logo file not found, invoice will be generated without logo');
        return null;
    }
    catch (error) {
        logger_1.logger.error('Error loading logo for invoice:', error);
        return null;
    }
};
/**
 ...
 * Returns PDF buffer
 */
const generateBookingInvoice = async (bookingId) => {
    let browser = null;
    try {
        ...
        logger_1.logger.error('Failed to generate booking invoice:', error);
        throw new ApiError_1.ApiError(500, (0, i18n_1.t)('errors.internalServerError'));
    }
};
exports.generateBookingInvoice = generateBookingInvoice;
