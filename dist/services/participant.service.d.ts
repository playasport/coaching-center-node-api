...
export declare const createParticipant: (data: ParticipantCreateInput, userId: string) => Promise<Participant>;
...
export declare const updateParticipant: (id: string, data: ParticipantUpdateInput, userId: string) => Promise<Participant | null>;
