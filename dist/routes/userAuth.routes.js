 ...
 */
router.post('/register', (0, validation_middleware_1.validate)(auth_validation_1.userRegisterSchema), userAuth_controller_1.registerUser);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/social-login', (0, validation_middleware_1.validate)(auth_validation_1.userSocialLoginSchema), userAuth_controller_1.socialLoginUser);
/**
 * @swagger
 * /user/auth/send-otp:
 *   post:
 ...
 */
router.post('/send-otp', (0, validation_middleware_1.validate)(auth_validation_1.userOtpSchema), userAuth_controller_1.sendUserOtp);
/**
 * @swagger
 ...
 */
router.post('/verify-otp', (0, validation_middleware_1.validate)(auth_validation_1.userVerifyOtpSchema), userAuth_controller_1.verifyUserOtp);
/**
 * @swagger
 * /user/auth/profile:
 *   patch:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.patch('/profile', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), upload_middleware_1.uploadProfileImage, (0, validation_middleware_1.validate)(auth_validation_1.userProfileUpdateSchema), userAuth_controller_1.updateUserProfile);
/**
 * @swagger
 * /user/auth/address:
 *   patch:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.patch('/address', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), (0, validation_middleware_1.validate)(auth_validation_1.userAddressUpdateSchema), userAuth_controller_1.updateUserAddress);
/**
 * @swagger
 * /user/auth/me:
 *   get:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/me', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), userAuth_controller_1.getCurrentUser);
/**
 * @swagger
 ...
 */
router.patch('/favorite-sports', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), (0, validation_middleware_1.validate)(auth_validation_1.userFavoriteSportsUpdateSchema), userAuth_controller_1.updateUserFavoriteSports);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/academy-bookmarks', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), userAuth_controller_1.getAcademyBookmarks);
router.post('/academy-bookmarks', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), (0, validation_middleware_1.validate)(auth_validation_1.addAcademyBookmarkSchema), userAuth_controller_1.addAcademyBookmark);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/academy-bookmarks/:academyId', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), (0, validation_middleware_1.validate)(auth_validation_1.academyIdParamSchema), userAuth_controller_1.removeAcademyBookmark);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/save-token', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), (0, validation_middleware_1.validate)(auth_validation_1.saveFcmTokenSchema), userAuth_controller_1.saveFcmToken);
/**
 * @swagger
 * /user/auth/refresh:
 *   post:
 ...
 */
router.post('/refresh', rateLimit_middleware_1.generalRateLimit, userAuth_controller_1.refreshToken);
/**
 * @swagger
 * /user/auth/logout:
 *   post:
 ...
 *         description: Unauthorized
 */
router.post('/logout', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), userAuth_controller_1.logout);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.post('/logout-all', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), userAuth_controller_1.logoutAll);
/**
 * @swagger
 * /user/auth/account:
 *   delete:
 ...
 */
router.delete('/account', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), userAuth_controller_1.deleteMyUserAccount);
/**
 * @swagger
 * /user/auth/devices:
 *   get:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/devices', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), userAuth_controller_1.getUserDevices);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/devices/:deviceTokenId', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.USER), userAuth_controller_1.logoutDevice);
