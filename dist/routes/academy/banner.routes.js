...
const bannerController = __importStar(require("../../controllers/academy/banner.controller"));
 ...
 */
router.get('/', auth_middleware_1.authenticate, bannerController.getAllCenterBanners);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:position', auth_middleware_1.authenticate, bannerController.getCenterBanners);
