...
const batchController = __importStar(require("../../controllers/academy/batch.controller"));
 ...
 */
router.post('/', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), (0, validation_middleware_1.validate)(batch_validation_1.batchCreateSchema), batchController.createBatch);
/**
 * @swagger
 ...
 *         description: Forbidden - ACADEMY role required
 */
router.get('/my/list', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), batchController.getMyBatches);
/**
 * @swagger
 ...
 */
router.get('/center/:centerId', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), batchController.getBatchesByCenter);
/**
 * @swagger
 * /academy/batch/{id}:
 *   get:
 ...
 */
router.get('/:id', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), batchController.getBatch);
/**
 * @swagger
 * /academy/batch/{id}:
 *   patch:
 ...
 *         description: Batch not found
 */
router.patch('/:id', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), (0, validation_middleware_1.validate)(batch_validation_1.batchUpdateSchema), batchController.updateBatch);
/**
 * @swagger
 ...
 *         description: Batch not found
 */
router.patch('/:id/toggle-status', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), batchController.toggleBatchStatus);
/**
 * @swagger
 * /academy/batch/{id}:
 *   delete:
 ...
 *         description: Batch not found
 */
router.delete('/:id', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), batchController.deleteBatch);
