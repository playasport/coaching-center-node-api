...
const bookingController = __importStar(require("../../controllers/academy/booking.controller"));
 ...
 */
router.get('/', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), (0, validation_middleware_1.validate)(booking_validation_1.academyBookingListSchema), bookingController.getBookings);
/**
 * @swagger
 ...
 *         description: Forbidden - ACADEMY role required
 */
router.get('/export', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), (0, validation_middleware_1.validate)(booking_validation_1.academyBookingExportSchema), bookingController.exportBookings);
/**
 * @swagger
 * /academy/booking/{id}:
 *   get:
 ...
 */
router.get('/:id', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), bookingController.getBookingById);
/**
 * @swagger
 ...
 *         description: Booking not found
 */
router.post('/:id/approve', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), bookingController.approveBookingRequest);
/**
 * @swagger
 ...
 *         description: Booking not found
 */
router.post('/:id/reject', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(defaultRoles_enum_1.DefaultRoles.ACADEMY), (0, validation_middleware_1.validate)(booking_validation_1.academyBookingActionSchema), bookingController.rejectBookingRequest);
