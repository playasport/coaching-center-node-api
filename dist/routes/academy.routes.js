 ...
 */
router.get('/', auth_middleware_1.optionalAuthenticate, academyController.getAllAcademies);
/**
 * @swagger
 * /academies/{id}:
 *   get:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:id', auth_middleware_1.optionalAuthenticate, academyController.getAcademyById);
/**
 * @swagger
 * /academies/{id}/rate:
 *   post:
 ...
 */
router.post('/:id/rate', auth_middleware_1.authenticate, academyController.submitRating);
/**
 * @swagger
 ...
 *                       type: integer
 */
router.get('/:id/ratings', auth_middleware_1.optionalAuthenticate, academyController.getRatingsByAcademyId);
/**
 * @swagger
 * /city/{cityName}:
 *   get:
