...
const permissionController = __importStar(require("../../controllers/admin/permission.controller"));
 ...
 */
router.post('/', requireSuperAdmin, (0, validation_middleware_1.validate)(permission_validation_1.createPermissionSchema), permissionController.createPermission);
/**
 * @swagger
 * /admin/permissions/{id}:
 *   patch:
 ...
 *               message: "Permission not found"
 */
router.patch('/:id', requireSuperAdmin, (0, validation_middleware_1.validate)(permission_validation_1.updatePermissionSchema), permissionController.updatePermission);
/**
 * @swagger
 * /admin/permissions/{id}:
 *   delete:
 ...
 *               message: "Role not found"
 */
router.post('/bulk', requireSuperAdmin, (0, validation_middleware_1.validate)(permission_validation_1.bulkUpdatePermissionsSchema), permissionController.bulkUpdatePermissions);
