 ...
 */
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.ROLE, section_enum_2.Action.VIEW), roleController.getAllRoles);
/**
 * @swagger
 * /admin/roles/{id}:
 *   get:
 ...
 */
router.get('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.ROLE, section_enum_2.Action.VIEW), roleController.getRoleById);
/**
 * @swagger
 * /admin/roles:
 *   post:
 ...
 */
router.post('/', requireSuperAdmin, (0, permission_middleware_1.requirePermission)(section_enum_1.Section.ROLE, section_enum_2.Action.CREATE), (0, validation_middleware_1.validate)(role_validation_1.createRoleSchema), roleController.createRole);
/**
 * @swagger
 * /admin/roles/{id}:
 *   patch:
 ...
 *         description: Role not found
 */
router.patch('/:id', requireSuperAdmin, (0, permission_middleware_1.requirePermission)(section_enum_1.Section.ROLE, section_enum_2.Action.UPDATE), (0, validation_middleware_1.validate)(role_validation_1.updateRoleSchema), roleController.updateRole);
/**
 * @swagger
 * /admin/roles/{id}:
 *   delete:
 ...
 *         description: Role not found
 */
router.delete('/:id', requireSuperAdmin, (0, permission_middleware_1.requirePermission)(section_enum_1.Section.ROLE, section_enum_2.Action.DELETE), roleController.deleteRole);
