...
const notificationController = __importStar(require("../../controllers/admin/notification.controller"));
 ...
 */
router.post('/send', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.NOTIFICATION, section_enum_2.Action.CREATE), (0, validation_middleware_1.validate)(notification_validation_1.sendNotificationSchema), notificationController.sendNotification);
/**
 * @swagger
 ...
 *         description: Recipient not found
 */
router.post('/test', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.NOTIFICATION, section_enum_2.Action.CREATE), (0, validation_middleware_1.validate)(notification_validation_1.testNotificationSchema), notificationController.testNotification);
/**
 * @swagger
 * /admin/notifications:
 *   get:
 ...
 */
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.NOTIFICATION, section_enum_2.Action.VIEW), notificationController.getAllNotifications);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get('/my', (0, validation_middleware_1.validate)(notification_validation_1.listNotificationsSchema), notificationController.getMyNotifications);
/**
 * @swagger
