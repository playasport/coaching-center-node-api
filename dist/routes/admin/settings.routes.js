...
const settingsController = __importStar(require("../../controllers/admin/settings.controller"));
const settingsUpload_middleware_1 = require("../../middleware/settingsUpload.middleware");
 ...
 */
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.VIEW), settingsController.getSettings);
/**
 * @swagger
 * /admin/settings:
 *   put:
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.put('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.UPDATE), settingsController.updateSettings);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.patch('/basic-info', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.UPDATE), settingsController.updateBasicInfo);
/**
 * @swagger
 * /admin/settings/logo:
 *   post:
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.post('/logo', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.UPDATE), settingsUpload_middleware_1.uploadSettingsLogo, settingsController.uploadLogo);
/**
 * @swagger
 * /admin/settings/fees:
 *   patch:
 ...
 *                 nullable: true
 *                 example: 18
 *                 description: GST percentage (0-100). GST is applied only on platform_fee, not on the entire booking amount.
 *               gst_enabled:
 *                 type: boolean
 *                 nullable: true
 *                 example: true
 *                 description: Whether GST is enabled. When enabled, GST is calculated on platform_fee only.
 *               currency:
 *                 type: string
 *                 nullable: true
 *                 example: "INR"
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.patch('/fees', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.UPDATE), settingsController.updateFeeConfig);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.patch('/notifications', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.UPDATE), settingsController.updateNotificationConfig);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.patch('/payment', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.UPDATE), settingsController.updatePaymentConfig);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.patch('/payment/toggle', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.UPDATE), settingsController.togglePayment);
/**
 * @swagger
 ...
 */
router.post('/reset', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.SETTINGS, section_enum_1.Action.UPDATE), settingsController.resetSettings);
