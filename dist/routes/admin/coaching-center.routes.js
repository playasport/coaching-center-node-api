...
const coachingCenterController = __importStar(require("../../controllers/admin/coachingCenter.controller"));
const validation_middleware_1 = require("../../middleware/validation.middleware");
const coachingCenter_validation_1 = require("../../validations/coachingCenter.validation");
...
const coachingCenterMedia_routes_1 = __importDefault(require("./coachingCenterMedia.routes"));
const coachingCenterUpload_middleware_1 = require("../../middleware/coachingCenterUpload.middleware");
const batchImportUpload_middleware_1 = require("../../middleware/batchImportUpload.middleware");
const router = (0, express_1.Router)();
// Media upload routes - defined before ID parameter routes to avoid conflict
router.use('/media', coachingCenterMedia_routes_1.default);
 ...
 */
router.get('/stats', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.getCoachingCenterStats);
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.getAllCoachingCenters);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.post('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.CREATE), (0, validation_middleware_1.validate)(coachingCenter_validation_1.adminCoachingCenterCreateSchema), coachingCenterController.createCoachingCenterByAdmin);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/user/:userId', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.getCoachingCentersByUserId);
/**
 * @swagger
 ...
 */
router.get('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.getCoachingCenter);
/**
 * @swagger
 ...
 */
router.patch('/:id/added-by', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.UPDATE), (0, validation_middleware_1.validate)(coachingCenter_validation_1.adminCoachingCenterUpdateAddedBySchema), coachingCenterController.updateCoachingCenterAddedBy);
/**
 * @swagger
 * /admin/coaching-centers/{id}:
 *   patch:
 ...
 *               message: "Coaching center not found"
 */
router.patch('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.UPDATE), (0, validation_middleware_1.validate)(coachingCenter_validation_1.adminCoachingCenterUpdateSchema), coachingCenterController.updateCoachingCenter);
/**
 * @swagger
 ...
 *                       $ref: '#/components/schemas/CoachingCenter'
 */
router.patch('/:id/toggle-status', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.UPDATE), coachingCenterController.toggleStatus);
/**
 * @swagger
 * /admin/coaching-centers/{id}:
 *   delete:
 ...
 *               message: "Coaching center not found"
 */
router.delete('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.DELETE), coachingCenterController.deleteCoachingCenter);
/**
 * @swagger
 ...
 */
router.delete('/:id/media', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.DELETE), coachingCenterController.removeMedia);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.post('/:id/banner-image', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.UPDATE), coachingCenterController.setBannerImage);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.post('/:id/video-thumbnail', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.UPDATE), coachingCenterUpload_middleware_1.uploadThumbnail, coachingCenterController.uploadVideoThumbnail);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/export/excel', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.exportToExcel);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/export/pdf', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.exportToPDF);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/export/csv', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.exportToCSV);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/export/basic-details', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.exportForBulkUpdate);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.post('/import', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.UPDATE), batchImportUpload_middleware_1.uploadBatchImportFile, coachingCenterController.importBasicDetails);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/export/academies', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), (req, res, next) => {
 ...
 *         description: Coaching center not found
 */
router.patch('/:id/approval', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.UPDATE), coachingCenterController.updateApprovalStatus);
/**
 * @swagger
 ...
 *         description: Coaching center not found
 */
router.get('/:id/coach', coachingCenterController.getCoaches);
/**
 * @swagger
 ...
 */
router.post('/:id/coach', coachingCenterController.createCoach);
/**
 * @swagger
 ...
 */
router.get('/:id/employees', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.COACHING_CENTER, section_enum_2.Action.VIEW), coachingCenterController.getEmployeesByCoachingCenterId);
exports.default = router;
//# sourceMappingURL=coaching-center.routes.js.map