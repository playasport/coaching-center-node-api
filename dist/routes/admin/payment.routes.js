...
const adminPaymentController = __importStar(require("../../controllers/admin/payment.controller"));
 ...
 *
 */
router.get('/stats', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.PAYMENT, section_enum_2.Action.VIEW), adminPaymentController.getPaymentStats);
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.PAYMENT, section_enum_2.Action.VIEW), adminPaymentController.getAllPayments);
/**
 * @swagger
 * /admin/payments/{id}:
 *   get:
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.PAYMENT, section_enum_2.Action.VIEW), adminPaymentController.getPaymentById);
