...
const adminHighlightController = __importStar(require("../../controllers/admin/highlight.controller"));
...
const highlight_validation_1 = require("../../validations/highlight.validation");
 ...
 */
router.post('/upload-video', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.CREATE), highlightUpload_middleware_1.uploadHighlightVideo, adminHighlightController.uploadHighlightVideo);
/**
 * @swagger
 ...
 */
router.post('/upload-thumbnail', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.CREATE), highlightUpload_middleware_1.uploadHighlightThumbnail, adminHighlightController.uploadHighlightThumbnail);
/**
 * @swagger
 ...
 */
router.post('/upload-media', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.CREATE), highlightUpload_middleware_1.uploadHighlightMedia, adminHighlightController.uploadHighlightMedia);
/**
 * @swagger
 * /admin/highlights:
 *   get:
 ...
 */
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.VIEW), adminHighlightController.getAllHighlights);
router.post('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.CREATE), adminHighlightController.createHighlight);
/**
 * @swagger
 * /admin/highlights/{id}:
 *   get:
 ...
 */
router.get('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.VIEW), adminHighlightController.getHighlightById);
router.patch('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.UPDATE), adminHighlightController.updateHighlight);
router.delete('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.DELETE), adminHighlightController.deleteHighlight);
/**
 * @swagger
 ...
 */
router.patch('/:id/status', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.UPDATE), (0, validation_middleware_1.validate)(highlight_validation_1.updateHighlightStatusSchema), adminHighlightController.updateHighlightStatus);
/**
 * @swagger
 ...
 */
router.post('/:id/process-video', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.UPDATE), adminHighlightController.reprocessHighlightVideo);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/:id/upload-preview', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.HIGHLIGHT, section_enum_2.Action.UPDATE), highlightUpload_middleware_1.uploadHighlightPreview, adminHighlightController.uploadHighlightPreview);
