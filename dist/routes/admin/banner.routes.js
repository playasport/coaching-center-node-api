...
const adminBannerController = __importStar(require("../../controllers/admin/banner.controller"));
const bannerImageController = __importStar(require("../../controllers/admin/bannerImage.controller"));
 ...
 */
router.post('/upload-image', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.CREATE), bannerUpload_middleware_1.uploadBannerImage, bannerImageController.uploadBannerImage);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/upload-images', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.CREATE), bannerUpload_middleware_1.uploadBannerImages, bannerImageController.uploadBannerImages);
/**
 * @swagger
 * /admin/banners:
 *   get:
 ...
 *
 */
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.VIEW), adminBannerController.getAllBanners);
router.post('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.CREATE), adminBannerController.createBanner);
router.get('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.VIEW), adminBannerController.getBannerById);
router.patch('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.UPDATE), adminBannerController.updateBanner);
router.delete('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.DELETE), adminBannerController.deleteBanner);
router.patch('/:id/status', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.UPDATE), adminBannerController.updateBannerStatus);
router.post('/reorder', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BANNER, section_enum_2.Action.UPDATE), adminBannerController.reorderBanners);
