...
const batchController = __importStar(require("../../controllers/admin/batch.controller"));
const validation_middleware_1 = require("../../middleware/validation.middleware");
const batch_validation_1 = require("../../validations/batch.validation");
 ...
 */
router.post('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.CREATE), (0, validation_middleware_1.validate)(batch_validation_1.batchCreateSchema), batchController.createBatch);
/**
 * @swagger
 * /admin/batches:
 *   get:
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.VIEW), batchController.getAllBatches);
/**
 * @swagger
 ...
 */
router.get('/export', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.VIEW), batchController.exportBatches);
/**
 * @swagger
 ...
 */
router.post('/import', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.UPDATE), batchImportUpload_middleware_1.uploadBatchImportFile, batchController.importBatches);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/user/:userId', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.VIEW), batchController.getBatchesByUserId);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/center/:centerId', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.VIEW), batchController.getBatchesByCenterId);
/**
 * @swagger
 * /admin/batches/{id}:
 *   get:
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.VIEW), batchController.getBatch);
/**
 * @swagger
 * /admin/batches/{id}:
 *   patch:
 ...
 *         description: Batch not found
 */
router.patch('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.UPDATE), (0, validation_middleware_1.validate)(batch_validation_1.batchUpdateSchema), batchController.updateBatch);
/**
 * @swagger
 ...
 *         description: Batch not found
 */
router.patch('/:id/toggle-status', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.UPDATE), batchController.toggleStatus);
/**
 * @swagger
 * /admin/batches/{id}:
 *   delete:
 ...
 *         description: Batch not found
 */
router.delete('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.DELETE), batchController.deleteBatch);
