...
const feeTypeConfigController = __importStar(require("../../controllers/admin/feeTypeConfig.controller"));
 ...
 */
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.VIEW), feeTypeConfigController.getAllFeeTypesHandler);
/**
 * @swagger
 ...
 */
router.get('/:feeType', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.BATCH, section_enum_2.Action.VIEW), feeTypeConfigController.getFeeTypeFormStructure);
