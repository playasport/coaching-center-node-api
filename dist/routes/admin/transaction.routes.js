...
const adminTransactionController = __importStar(require("../../controllers/admin/transaction.controller"));
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/stats', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.TRANSACTION, section_enum_2.Action.VIEW), adminTransactionController.getTransactionStats);
/**
 * @swagger
 ...
 *         description: Forbidden - Insufficient permissions
 */
router.get('/export', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.TRANSACTION, section_enum_2.Action.VIEW), adminTransactionController.exportTransactions);
router.get('/', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.TRANSACTION, section_enum_2.Action.VIEW), adminTransactionController.getAllTransactions);
router.get('/:id', (0, permission_middleware_1.requirePermission)(section_enum_1.Section.TRANSACTION, section_enum_2.Action.VIEW), adminTransactionController.getTransactionById);
