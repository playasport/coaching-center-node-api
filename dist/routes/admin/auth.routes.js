...
const adminAuthController = __importStar(require("../../controllers/admin/adminAuth.controller"));
const auth_middleware_1 = require("../../middleware/auth.middleware");
const admin_middleware_1 = require("../../middleware/admin.middleware");
const validation_middleware_1 = require("../../middleware/validation.middleware");
const rateLimit_middleware_1 = require("../../middleware/rateLimit.middleware");
const upload_middleware_1 = require("../../middleware/upload.middleware");
const adminAuth_validation_1 = require("../../validations/adminAuth.validation");
 ...
 *               message: "Forbidden"
 */
router.post('/login', (0, validation_middleware_1.validate)(adminAuth_validation_1.adminLoginSchema), adminAuthController.loginAdmin);
/**
 * @swagger
 * /admin/auth/profile:
 *   get:
 ...
 */
router.get('/profile', auth_middleware_1.authenticate, admin_middleware_1.requireAdmin, adminAuthController.getAdminProfile);
/**
 * @swagger
 * /admin/auth/profile:
 *   patch:
 ...
 *               message: "Unauthorized"
 */
router.patch('/profile', auth_middleware_1.authenticate, admin_middleware_1.requireAdmin, (0, validation_middleware_1.validate)(adminAuth_validation_1.adminUpdateProfileSchema), adminAuthController.updateAdminProfile);
/**
 * @swagger
 ...
 */
router.patch('/profile/image', auth_middleware_1.authenticate, admin_middleware_1.requireAdmin, upload_middleware_1.uploadImage, adminAuthController.updateAdminProfileImage);
/**
 * @swagger
 * /admin/auth/password:
 *   patch:
 ...
 *               message: "Unauthorized"
 */
router.patch('/password', auth_middleware_1.authenticate, admin_middleware_1.requireAdmin, (0, validation_middleware_1.validate)(adminAuth_validation_1.adminChangePasswordSchema), adminAuthController.changePassword);
/**
 * @swagger
 * /admin/auth/refresh:
 *   post:
 ...
 *               message: "Forbidden"
 */
router.post('/refresh', rateLimit_middleware_1.generalRateLimit, (0, validation_middleware_1.validate)(adminAuth_validation_1.adminRefreshTokenSchema), adminAuthController.refreshToken);
/**
 * @swagger
 * /admin/auth/logout:
 *   post:
 ...
 *               message: "Unauthorized"
 */
router.post('/logout', auth_middleware_1.authenticate, admin_middleware_1.requireAdmin, adminAuthController.logout);
/**
 * @swagger
 ...
 *               message: "Unauthorized"
 */
router.post('/logout-all', auth_middleware_1.authenticate, admin_middleware_1.requireAdmin, adminAuthController.logoutAll);
