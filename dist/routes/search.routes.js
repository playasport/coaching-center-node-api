 ...
 */
router.get('/autocomplete', auth_middleware_1.optionalAuthenticate, search_controller_1.autocomplete);
/**
 * @swagger
 * /search:
 *   get:
 ...
 *         description: Service unavailable (Meilisearch disabled - will use MongoDB fallback)
 */
router.get('/', auth_middleware_1.optionalAuthenticate, search_controller_1.search);
