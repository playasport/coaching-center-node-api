...
const mediaController = __importStar(require("../controllers/coachingCenterMedia.controller"));
 ...
 */
router.post('/', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(role_model_1.DefaultRoles.ACADEMY), coachingCenterUpload_middleware_1.uploadMedia, mediaController.uploadMedia);
