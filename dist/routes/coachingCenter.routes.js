...
const coachingCenterController = __importStar(require("../controllers/coachingCenter.controller"));
 ...
 */
router.post('/', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(role_model_1.DefaultRoles.ACADEMY), (0, validation_middleware_1.validate)(coachingCenter_validation_1.coachingCenterCreateSchema), coachingCenterController.createCoachingCenter);
/**
 * @swagger
 ...
 */
router.get('/my/list', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(role_model_1.DefaultRoles.ACADEMY), coachingCenterController.getMyCoachingCenters);
/**
 * @swagger
 * /coaching-center/{id}:
 *   get:
 ...
 *         description: Email or mobile number already exists
 */
router.patch('/:id', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(role_model_1.DefaultRoles.ACADEMY), (0, validation_middleware_1.validate)(coachingCenter_validation_1.coachingCenterUpdateSchema), coachingCenterController.updateCoachingCenter);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.patch('/:id/toggle-status', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(role_model_1.DefaultRoles.ACADEMY), coachingCenterController.toggleCoachingCenterStatus);
/**
 * @swagger
 * /coaching-center/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(role_model_1.DefaultRoles.ACADEMY), coachingCenterController.deleteCoachingCenter);
/**
 * @swagger
 ...
 */
router.delete('/:id/media', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(role_model_1.DefaultRoles.ACADEMY), coachingCenterController.removeMedia);
// Media upload routes
