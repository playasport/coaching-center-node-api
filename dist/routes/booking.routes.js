 ...
 */
router.get('/summary', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.bookingSummarySchema), bookingController.getSummary);
/**
 * @swagger
 ...
 */
router.post('/verify-payment', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.verifyPaymentSchema), bookingController.verifyPayment);
/**
 * @swagger
 * /user/booking:
 *   get:
 ...
 *         description: Unauthorized - Authentication required
 */
router.get('/', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.userBookingListSchema), bookingController.getUserBookings);
/**
 * @swagger
 ...
 */
router.delete('/delete-order', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.deleteOrderSchema), bookingController.deleteOrder);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.post('/book-slot', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.bookSlotSchema), bookingController.bookSlot);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.post('/:bookingId/create-payment-order', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.createPaymentOrderSchema), bookingController.createPaymentOrder);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.post('/:bookingId/cancel', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.cancelBookingSchema), bookingController.cancelBooking);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get('/:bookingId', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.getBookingDetailsSchema), bookingController.getBookingDetails);
/**
 * @swagger
 ...
 */
router.get('/:bookingId/invoice', auth_middleware_1.authenticate, (0, validation_middleware_1.validate)(booking_validation_1.getBookingDetailsSchema), bookingController.downloadInvoice);
